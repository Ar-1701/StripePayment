...
Route::get('/cart_view', [StripePaymentController::class, 'cart_view']);
Route::get('/refundBack', [StripePaymentController::class, 'refundBack']);
Route::get('/stripe', [StripePaymentController::class, 'stripe']);
Route::get('save-add-tocart', [StripePaymentController::class, 'dataSend']);
Route::post('update_qty', [StripePaymentController::class, 'update_qty']);
